...
public class InterrupteurSalleàMangerManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (OVRInput.GetDown(OVRInput.Button.Two) && InteractionController.s_Singleton.getTarget.CompareTag("InterrupteurSalleàManger") && EventManager.s_Singleton.actualStepFirstEvent != 1 && EventManager.s_Singleton.actualStepFirstEvent != 2 && EventManager.s_Singleton.actualStepFirstEvent != 3)
        {
